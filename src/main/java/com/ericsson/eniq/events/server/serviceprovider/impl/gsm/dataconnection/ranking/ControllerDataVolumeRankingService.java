...
@Stateless
@Local(Service.class)
public class ControllerDataVolumeRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return GSM_DATA_CONNECTION_CONTROLLER_DATA_VOLUME_RANKING_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificDataServiceParameters(
        ...
        dataParams.put(TZ_OFFSET, requestParams.getFirst(TZ_OFFSET));
        return dataParams;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(HIER3, EventDataSourceType.AGGREGATED_15MIN, EventDataSourceType.AGGREGATED_DAY);
    }
