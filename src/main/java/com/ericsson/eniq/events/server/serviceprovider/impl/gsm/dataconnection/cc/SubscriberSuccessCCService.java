 ...
 * -----------------------------------------------------------------------
 */
package com.ericsson.eniq.events.server.serviceprovider.impl.gsm.dataconnection.cc;
...
@Stateless
@Local(Service.class)
public class SubscriberSuccessCCService extends GenericService {
    ...
    public String getTemplatePath() {
        return GSM_DATA_CONNECTION_SUBSCRIBER_SUCCESS_CAUSE_CODE_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (requestParameters.containsKey(CAUSE_CODE)) {
            //the pie chart sends this but we don't need it.
            //it sends it because the other slices send it.
    ...
    public MultivaluedMap<String, String> getStaticParameters() {
        ...
        staticParameters.add(TYPE_PARAM, TYPE_IMSI);
