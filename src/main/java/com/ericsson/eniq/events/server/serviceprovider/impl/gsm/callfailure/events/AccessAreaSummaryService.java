...
@Stateless
@Local(Service.class)
public class AccessAreaSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return GSM_ACCESS_AREA_CALL_FAILURE_EVENT_SUMMARY;
    }
            ...
            if (node != null) {
                ...
                if (cellGroupName != null) {
                    ...
                    if (allData != null && allData.length == 5) {
                        final long hashedIdForCell = getQueryUtils().createHashIDForCell(allData[4], allData[2],
                                allData[1], allData[0], allData[3]);
                        queryParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(hashedIdForCell));
                    } else {
                        queryParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(Long.valueOf(0)));
                    }
                }
            }
        } else {
