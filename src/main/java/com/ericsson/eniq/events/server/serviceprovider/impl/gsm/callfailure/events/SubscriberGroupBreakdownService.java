...
@Stateless
@Local(Service.class)
public class SubscriberGroupBreakdownService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(CATEGORY_ID_DESC_PARAM,
                requestParameters.getFirst(CATEGORY_ID_DESC_PARAM));
    ...
    public String getTemplatePath() {
        return GSM_CALL_FAILURE_IMSI_GROUP_SUMMARY_BREAKDOWN;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final String imsiGroupName = requestParameters.getFirst(GROUP_NAME_PARAM);
        if (imsiGroupName != null) {
            queryParameters.put(GROUP_NAME_PARAM, QueryParameter.createStringParameter(imsiGroupName));
        }
