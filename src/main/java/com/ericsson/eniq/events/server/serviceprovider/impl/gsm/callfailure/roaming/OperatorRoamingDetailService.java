...
@Stateless
@Local(Service.class)
public class OperatorRoamingDetailService extends GenericService {

    @Override
    public String getTemplatePath() {
        return GSM_CFA_OPERATOR_ROAMING_DETAIL_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        if (requestParameters.containsKey(OPERATOR)) {
            serviceSpecificTemplateParameters.put(OPERATOR, requestParameters.getFirst(OPERATOR));
        }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (requestParameters.containsKey(MNC_PARAM)) {
            queryParameters.put(IMSI_MNC_PARAM,
                    QueryParameter.createStringParameter(requestParameters.getFirst(MNC_PARAM)));
        }
