...
@Stateless
@Local(Service.class)
public class ControllerCCService extends GenericService {
    ...
    public String getTemplatePath() {
        return GSM_CALL_FAILURE_CONTROLLER_CAUSE_CODE_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        } else if (requestParameters.containsKey(CONTROLLER) && requestParameters.containsKey(FAILURE_TYPE_PARAM)) {
            serviceSpecificTemplateParameters.put(NODE_PARAM, requestParameters.getFirst(CONTROLLER) + " - "
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo("HIER3_CG");
    }
