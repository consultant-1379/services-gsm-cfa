...
@Stateless
@Local(Service.class)
public class ControllerGroupEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return GSM_CALL_FAILURE_BSC_GROUP_EVENT_ANALYSIS_SERVICE;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.ericsson.eniq.events.server.servicepreeovider.impl.
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        // String hashedIdForController =
        // requestParameters.getFirst(CONTROLLER_SQL_ID);
        //queryParameters.put(GROUP_NAME_PARAM, QueryParameter.createStringParameter(requestParameters.getFirst(GROUP_NAME_PARAM)));
