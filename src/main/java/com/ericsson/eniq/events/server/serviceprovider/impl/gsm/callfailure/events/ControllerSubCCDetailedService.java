...
@Stateless
@Local(Service.class)
public class ControllerSubCCDetailedService extends GenericService {
    ...
    public String getTemplatePath() {
        return GSM_DETALIED_EVENT_CFA_BY_SUB_CAUSE_CODE;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (node != null) {
            ...
            if (nodeComponents != null && nodeComponents.length == 3) {
                hashedIdForController = getQueryUtils().createHashIDForController(nodeComponents[2], nodeComponents[0],
                        nodeComponents[1]);
            }
        }
