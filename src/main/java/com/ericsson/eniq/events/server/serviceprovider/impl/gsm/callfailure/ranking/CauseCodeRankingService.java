...
@Stateless
@Local(Service.class)
public class CauseCodeRankingService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(CATEGORY_ID_PARAM, GSM_CALL_DROP_CATEGORY_ID);
    ...
    public String getTemplatePath() {
        return GSM_CALL_FAILURE_CAUSE_CODE_CALL_DROP_RANKING;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo("HIER3_UC");
    }
