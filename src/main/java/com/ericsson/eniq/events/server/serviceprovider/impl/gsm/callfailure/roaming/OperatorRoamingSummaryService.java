...
@Stateless
@Local(Service.class)
public class OperatorRoamingSummaryService extends GenericService {

    private static final String GSM_CALL_DROP_OPERATOR_ROAMING_ANALYSIS = "GSM_CALL_DROP_OPERATOR_ROAMING_ANALYSIS";
    ...
    public String getTemplatePath() {
        return GSM_CALL_DROP_OPERATOR_ROAMING_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        templateParameters.put(AGGREGATION_VIEW, techPackList.getTechPack(EVENT_E_GSM_CFA).getPlainAggregationView());
