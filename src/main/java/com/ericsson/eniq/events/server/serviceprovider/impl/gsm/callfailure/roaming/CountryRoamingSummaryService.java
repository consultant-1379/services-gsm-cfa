...
@Stateless
@Local(Service.class)
public class CountryRoamingSummaryService extends GenericService {

    private static final String GSM_CALL_DROP_COUNTRY_ROAMING_ANALYSIS = "GSM_CALL_DROP_COUNTRY_ROAMING_ANALYSIS";
    ...
    public String getTemplatePath() {
        return GSM_CALL_DROP_COUNTRY_ROAMING_ANALYSIS;
    }
