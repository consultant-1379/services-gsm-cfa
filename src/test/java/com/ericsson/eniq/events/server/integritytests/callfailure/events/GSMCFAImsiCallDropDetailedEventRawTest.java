...
import com.ericsson.eniq.events.server.test.queryresults.gsm.callfailure.GSMCallFailureSubscriberDetailedEventAnalysisResult;
...
public class GSMCFAImsiCallDropDetailedEventRawTest extends
        BaseDataIntegrityTest<GSMCallFailureSubscriberDetailedEventAnalysisResult> {
    ...
    public void testTacQuery() throws URISyntaxException, Exception {
        ...
        final List<GSMCallFailureSubscriberDetailedEventAnalysisResult> results = getTranslator().translateResult(
                result, GSMCallFailureSubscriberDetailedEventAnalysisResult.class);
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "GSM_SUBSCRIBER_DETAILED_EVENT_ANALYSIS_BY_IMSI");
        final List<GSMCallFailureSubscriberDetailedEventAnalysisResult> results = getTranslator().translateResult(json,
                GSMCallFailureSubscriberDetailedEventAnalysisResult.class);

        assertThat(results.size(), is(1));
        final GSMCallFailureSubscriberDetailedEventAnalysisResult result = results.get(0);
