...
import com.ericsson.eniq.events.server.test.queryresults.gsm.callfailure.GSMCallFailureBscGroupDetailedEventAnalysisResult;
 ...
 *
 */
public class GSMCFABscGroupDetailedEventRawTest extends
        BaseDataIntegrityTest<GSMCallFailureBscGroupDetailedEventAnalysisResult> {
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "NETWORK_RAN_GSM_DETAILED_EVENT_ANALYSIS_BSC_GROUP");
        final List<GSMCallFailureBscGroupDetailedEventAnalysisResult> results = getTranslator().translateResult(json,
                GSMCallFailureBscGroupDetailedEventAnalysisResult.class);

        assertThat(results.size(), is(2));
        final GSMCallFailureBscGroupDetailedEventAnalysisResult result = results.get(0);
    ...
    private void createLookupTables() throws Exception {
        ...
        createAndReplaceLookupTable(TEMP_DIM_E_GSM_CFA_RELEASE_TYPE, "DIM_E_GSM_CFA_RELEASE_TYPE", RELEASE_TYPE,
                RELEASE_TYPE_DESC);
        createAndReplaceLookupTable(TEMP_DIM_E_SGEH_HIER321, "DIM_E_SGEH_HIER321", HIERARCHY_1, HIERARCHY_3,
