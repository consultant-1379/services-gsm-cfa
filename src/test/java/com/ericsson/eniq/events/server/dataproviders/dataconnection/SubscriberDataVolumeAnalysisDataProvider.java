...
public class SubscriberDataVolumeAnalysisDataProvider {
	...
	public static Object[] provideTestData() {
		...
		final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
				...
				.add(MAX_ROWS, DEFAULT_MAX_ROWS).add(TYPE_PARAM, TYPE_IMSI)
				.add(IMSI_PARAM_UPPER_CASE, TEST_VALUE_IMSI + "").build();
