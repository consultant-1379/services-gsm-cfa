 ...
 *
 */
public class GSMCallFailureControllerCauseCodeAnalysisChartDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(NODE_PARAM, TEST_BSC1_NODE).add(TYPE_PARAM, BSC).add(CAUSE_CODE_ID_LIST, "1,2").build();
