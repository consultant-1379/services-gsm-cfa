...
import com.ericsson.eniq.events.server.test.queryresults.gsm.callfailure.GSMCallSetupFailureCountryRoamingDetailQueryResult;
 ...
 *
 */
public class CountryRoamingDetailServiceCallSetupIntegrityTest extends
        BaseDataIntegrityTest<GSMCallSetupFailureCountryRoamingDetailQueryResult> {
    ...
    private static final String TEST_VALUE_AF_CAUSE_DESC = "CALL CONTROL, BSC Originated";
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "GSM_CSF_COUNTRY_ROAMING_DETAILED_ANALYSIS");
        final List<GSMCallSetupFailureCountryRoamingDetailQueryResult> results = getTranslator().translateResult(json,
                GSMCallSetupFailureCountryRoamingDetailQueryResult.class);

        assertThat(results.size(), is(1));
        final GSMCallSetupFailureCountryRoamingDetailQueryResult result = results.get(0);
        ...
        assertThat(result.getAfCause(), is(TEST_VALUE_AF_CAUSE_DESC));
    ...
    public void testTacQuery() throws URISyntaxException, Exception {
        ...
        final List<GSMCallSetupFailureCountryRoamingDetailQueryResult> results = getTranslator().translateResult(
                result, GSMCallSetupFailureCountryRoamingDetailQueryResult.class);

        assertThat(results.size(), is(1));
    }

    private void insertEventData(final String dateTime) throws Exception {
        insertData(TEST_VALUE_IMSI1, GSM_CALL_SETUP_FAILURE_CATEGORY_ID, TEST_VALUE_TAC, dateTime, 1);
