...
import com.ericsson.eniq.events.server.dataproviders.dataconnection.CCDetailedEAImsiGroupDataProvider;
...
public class CCDetailedEAImsiGroupIntTest extends ServiceBaseTest {

    @Resource(name = "causeCodeDetailedEventAnalysisImsi")
    private SubscriberCCDetailedService causeCodeDetailedEventAnalysisImsi;

    @Test
    @Parameters(source = CCDetailedEAImsiGroupDataProvider.class)
