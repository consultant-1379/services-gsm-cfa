...
import com.ericsson.eniq.events.server.test.queryresults.gsm.callfailure.GSMCallDropOperatorRoamingDetailQueryResult;
 ...
 *
 */
public class OperatorRoamingDetailServiceCallDropIntegrityTest extends
        BaseDataIntegrityTest<GSMCallDropOperatorRoamingDetailQueryResult> {
    ...
    private OperatorRoamingDetailService service;

    @Before
    public void setup() throws Exception {
        service = new OperatorRoamingDetailService();
    ...
    public void testFiveMinuteQuery() throws URISyntaxException, Exception {
        ...
        requestParameters.add(OPERATOR, TEST_VALUE_OPERATOR);
        requestParameters.add(MCC, TEST_VALUE_MCC);
        requestParameters.add(MNC, TEST_VALUE_MNC);
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "GSM_OPERATOR_ROAMING_DETAILED_ANALYSIS");
        final List<GSMCallDropOperatorRoamingDetailQueryResult> results = getTranslator().translateResult(json,
                GSMCallDropOperatorRoamingDetailQueryResult.class);

        assertThat(results.size(), is(1));
        final GSMCallDropOperatorRoamingDetailQueryResult result = results.get(0);
    ...
    public void testTacQuery() throws URISyntaxException, Exception {
        ...
        final List<GSMCallDropOperatorRoamingDetailQueryResult> results = getTranslator().translateResult(result,
                GSMCallDropOperatorRoamingDetailQueryResult.class);
