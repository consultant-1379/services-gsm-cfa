 ...
 *
 */
public class GSMCallFailureAccessAreaGroupEventAnlysisDataProvider {
    public static Object[] provideTestData() {

        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(DISPLAY_PARAM, GRID_PARAM)
                .add(TIME_QUERY_PARAM, ONE_DAY)
                ...
                .add(CATEGORY_ID, GSM_CALL_SETUP_FAILURE_CATEGORY_ID).add(TYPE_PARAM, TYPE_CELL)
                .add(GROUP_NAME_PARAM, "Test_Group").build();
