...
import com.ericsson.eniq.events.server.test.queryresults.gsm.callfailure.GSMCallSetupFailureCellDetailSCCEventAnalysisResult;
...
public class GSMCFACSFCellSCCDetailedEventRawTest extends
        BaseDataIntegrityTest<GSMCallSetupFailureCellDetailSCCEventAnalysisResult> {
    ...
    private static final String TEST_VALUE_CATEGORY_ID_CSF_DESC = "Call Setup";
    ...
    private static final String TEST_VALUE_AF_CAUSE = "1";

    private static final String TEST_VALUE_AF_ID = "1";

    private static final String TEST_VALUE_SHORT_DESC = "RADIO INTERFERENCE MESSAGE FAILURE";

    private static final String TEST_VALUE_ORIGIN = "BSC Generated";
    ...
    public void testCellFiveMinuteQueryForGrid() throws URISyntaxException, Exception {
        ...
        requestParameters.add(CATEGORY_ID, TEST_VALUE_CALL_SETUP_CATEGORY_ID);
    ...
    private void verifyResultForGrid(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "GSM_NETWORK_csf_CC_SCC_DETAILED_EVENT_ANALYSIS_CELL_DETAIL");
        final List<GSMCallSetupFailureCellDetailSCCEventAnalysisResult> results = getTranslator().translateResult(json,
                GSMCallSetupFailureCellDetailSCCEventAnalysisResult.class);
        assertThat(cellHashId, is(TEST_VALUE_HIER321_ID_1));
        assertThat(results.size(), is(1));

        for (final GSMCallSetupFailureCellDetailSCCEventAnalysisResult result : results) {
            ...
            assertThat(result.getEventType(), is(TEST_VALUE_CATEGORY_ID_CSF_DESC));
            ...
            assertThat(result.getAfCause(), is(TEST_VALUE_SHORT_DESC + ", " + TEST_VALUE_ORIGIN));
        }
    }
    ...
    private void insertData(final String imsi, final int tac, final long hier321_id, final String causeCode,
        ...
        for (int i = 0; i < instances; i++) {
            ...
            dataForEventTable.put(CATEGORY_ID, GSM_CALL_SETUP_FAILURE_CATEGORY_ID);
            ...
            dataForEventTable.put(AF_ID, TEST_VALUE_AF_ID);
            dataForEventTable.put(AF_CAUSE, TEST_VALUE_AF_CAUSE);
    ...
    private void createLookupTables() throws Exception {
        ...
        createAndReplaceLookupTable(TEMP_DIM_E_GSM_CFA_CHANNEL_TYPE, "DIM_E_GSM_CFA_CHANNEL_TYPE", CHANNEL_TYPE,
                CHANNEL_TYPE_DESC);
        createAndReplaceLookupTable(TEMP_DIM_E_GSM_CFA_AF_CAUSE, "DIM_E_GSM_CFA_AF_CAUSE", AF_ID, AF_CAUSE, SHORT_DESC,
                ORIGIN);
    ...
    private void insertAllLookupData() throws SQLException {
        ...
        valuesForTable.put(CATEGORY_ID_DESC, TEST_VALUE_CATEGORY_ID_CSF_DESC);
        ...
        valuesForTable.clear();
        valuesForTable.put(AF_ID, TEST_VALUE_AF_ID);
        valuesForTable.put(AF_CAUSE, TEST_VALUE_AF_CAUSE);
        valuesForTable.put(SHORT_DESC, TEST_VALUE_SHORT_DESC);
        valuesForTable.put(ORIGIN, TEST_VALUE_ORIGIN);
