 ...
 *
 */
public class GSMCallFailureSubscriberCallDropDetailedEventAnalysisDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(IMSI_PARAM_UPPER_CASE, TEST_VALUE_IMSI + "").add(CATEGORY_ID, GSM_CALL_DROP_CATEGORY_ID).build();
