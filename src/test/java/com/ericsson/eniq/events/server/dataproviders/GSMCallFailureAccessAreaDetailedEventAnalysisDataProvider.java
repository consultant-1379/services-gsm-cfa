 ...
 *
 */
public class GSMCallFailureAccessAreaDetailedEventAnalysisDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(NODE_PARAM,
                        TEST_VALUE_GSM_CELL1_NAME + "," + "" + "," + TEST_VALUE_GSM_CONTROLLER1_NAME + "," + "Ericsson"
                                + "," + "0").add(CATEGORY_ID, GSM_CALL_DROP_CATEGORY_ID).build();
