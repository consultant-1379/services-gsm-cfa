...
import com.ericsson.eniq.events.server.test.queryresults.gsm.callfailure.GSMCallSetupFailureSubscriberDetailedEventAnalysisResult;
import com.ericsson.eniq.events.server.test.util.DateTimeUtilities;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class GSMCFAImsiCallSetupFailureDetailedEventRawTest extends
        BaseDataIntegrityTest<GSMCallSetupFailureSubscriberDetailedEventAnalysisResult> {
    ...
    public void testFiveMinuteQuery() throws URISyntaxException, Exception {
        ...
        requestParameters.add(IMSI_PARAM_UPPER_CASE, TEST_VALUE_IMSI1);
    ...
    public void testTacQuery() throws URISyntaxException, Exception {
        ...
        final List<GSMCallSetupFailureSubscriberDetailedEventAnalysisResult> results = getTranslator().translateResult(
                result, GSMCallSetupFailureSubscriberDetailedEventAnalysisResult.class);
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "GSM_CSF_SUBSCRIBER_DETAILED_EVENT_ANALYSIS_BY_IMSI");
        final List<GSMCallSetupFailureSubscriberDetailedEventAnalysisResult> results = getTranslator().translateResult(
                json, GSMCallSetupFailureSubscriberDetailedEventAnalysisResult.class);

        assertThat(results.size(), is(1));
        final GSMCallSetupFailureSubscriberDetailedEventAnalysisResult result = results.get(0);
        ...
        assertThat(result.getAfCause(), is("CALL CONTROL, BSC Originated"));
