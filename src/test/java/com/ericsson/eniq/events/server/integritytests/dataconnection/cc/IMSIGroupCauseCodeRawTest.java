 ...
 *
 */
public class IMSIGroupCauseCodeRawTest extends BaseDataIntegrityTest<CauseCodePieChartResult> {
    ...
    private static final String TEST_VALUE_TBF_RELEASE_CAUSE_8 = "8";
    ...
    public void testIMSIFiveMinuteQueryWithSuccessAndErrorCCs() throws URISyntaxException, Exception {
        final String result = runFiveMinCauseCodeQuery(DATA_CONNECTION_SUCCESS_CAUSE_CODE_ID_LABEL + ",0,2,3,4,5,6,7");
    ...
    public void testIMSIFiveMinuteQueryWithErrorCCsOnly() throws URISyntaxException, Exception {
        final String result = runFiveMinCauseCodeQuery("0,2,3,4,5,6,7");
    ...
    private void verifyMixedResult(final String json) throws Exception {
        ...
        assertThat(results.size(), is(4));//success included, and 2 other cause codes
        ...
        assertThat(results.get(0).getNoImpactedSubscribers(), is(2));
        ...
        assertThat(results.get(3).getNoOccurrences(), is(9));
        assertThat(results.get(3).getNoImpactedSubscribers(), is(0));
    ...
    private void insertEventData() throws Exception {
        ...
        insertData(true, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime2mins, 1, TEST_VALUE_TAC);//should be in result
        insertData(true, TEST_VALUE_IMSI2, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime2mins, 2, TEST_VALUE_TAC);//should be in result
        insertData(true, TEST_VALUE_IMSI3, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime2mins, 7, TEST_VALUE_TAC);//not expected in result - imsi not in group
        insertData(true, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime3mins, 3, TEST_VALUE_TAC);//should be in result
        insertData(true, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime48Hours, 3, TEST_VALUE_TAC);//not expected in result - outside time limit
        insertData(true, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime3mins, 3, SAMPLE_EXCLUSIVE_TAC);//not expected in result - tacs excluded for imsi group request
        insertData(true, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_2, dateTime2mins, 1, TEST_VALUE_TAC);//should be in result
        insertData(true, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_4, dateTime2mins, 1, TEST_VALUE_TAC);//should be in result
        insertData(true, TEST_VALUE_IMSI3, TEST_VALUE_TBF_RELEASE_CAUSE_5, dateTime2mins, 2, TEST_VALUE_TAC);//not expected in result - imsi not in group
        insertData(true, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_8, dateTime2mins, 1, TEST_VALUE_TAC);//should be in result

        insertData(false, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime2mins, 1, TEST_VALUE_TAC);//should be in result
        insertData(false, TEST_VALUE_IMSI3, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime2mins, 2, TEST_VALUE_TAC);//not expected in result - imsi not in group
        insertData(false, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime3mins, 3, TEST_VALUE_TAC);//should be in result
        insertData(false, TEST_VALUE_IMSI2, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime3mins, 4, TEST_VALUE_TAC);//should be in result
        insertData(false, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_0, dateTime48Hours, 9, TEST_VALUE_TAC); //not expected in result - outside time limit
        insertData(false, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_6, dateTime48Hours, 6, TEST_VALUE_TAC); //not expected in result - outside time limit
        insertData(false, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_4, dateTime3mins, 3, SAMPLE_EXCLUSIVE_TAC);//not expected in result - tacs excluded for imsi group request
        insertData(false, TEST_VALUE_IMSI1, TEST_VALUE_TBF_RELEASE_CAUSE_3, dateTime2mins, 1, TEST_VALUE_TAC);//should be in result
        insertData(false, TEST_VALUE_IMSI2, TEST_VALUE_TBF_RELEASE_CAUSE_7, dateTime2mins, 2, TEST_VALUE_TAC);//should be in result
        insertData(false, TEST_VALUE_IMSI2, TEST_VALUE_TBF_RELEASE_CAUSE_8, dateTime2mins, 2, TEST_VALUE_TAC);//not expected in result - cc id not in list
    }
