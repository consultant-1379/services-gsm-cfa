 ...
 *
 */
public class GSMCFASubscriberGroupCallDropDetailedEventDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(CATEGORY_ID, GSM_CALL_DROP_CATEGORY_ID).add(TYPE_PARAM, TYPE_IMSI).add(IMSI, "123456789")
                .add(GROUP_NAME_PARAM, "IMSIGroup1").build();
