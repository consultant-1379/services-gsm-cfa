...
import com.ericsson.eniq.events.server.test.queryresults.gsm.callfailure.GSMCallFailureTerminalCallDropDetailedEventAnalysisResult;
...
public class GSMCFATerminalCallDropDetailedEventRawTest extends
        BaseDataIntegrityTest<GSMCallFailureTerminalCallDropDetailedEventAnalysisResult> {
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "NETWORK_DETAILED_EVENT_ANALYSIS_GSM_CFA_TAC_CALL_DROPS");
        final List<GSMCallFailureTerminalCallDropDetailedEventAnalysisResult> results = getTranslator()
                .translateResult(json, GSMCallFailureTerminalCallDropDetailedEventAnalysisResult.class);

        assertThat(results.size(), is(1));
        final GSMCallFailureTerminalCallDropDetailedEventAnalysisResult result = results.get(0);
    ...
    private void insertEventData(final String dateTime) throws Exception {
        insertData(TEST_VALUE_IMSI1, GSM_CALL_DROP_CATEGORY_ID, SAMPLE_TAC, dateTime, 1);
