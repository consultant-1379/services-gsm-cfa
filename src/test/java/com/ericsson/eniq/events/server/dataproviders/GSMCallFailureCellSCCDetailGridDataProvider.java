 ...
 *
 */
public class GSMCallFailureCellSCCDetailGridDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(NODE_PARAM, TEST_VALUE_MSS_CELL_NODE).add(TYPE_PARAM, TYPE_CELL).add(CAUSE_CODE_PARAM, "1")
                .add(SUB_CAUSE_CODE_PARAM, "1").add(CATEGORY_ID, GSM_CALL_DROP_CATEGORY_ID).build();
