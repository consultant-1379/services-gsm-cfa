 ...
 *
 */
public class CCDetailedEAImsiGroupDataProvider {
    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(TYPE_PARAM, TYPE_IMSI + "").add(GROUP_NAME_PARAM, "IMSIGroup1")
                .add(CAUSE_CODE_PARAM, TEST_VALUE_TBF_RELEASE_CAUSE + "").build();
