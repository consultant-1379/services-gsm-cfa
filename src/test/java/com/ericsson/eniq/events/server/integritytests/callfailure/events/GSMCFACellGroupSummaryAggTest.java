 ...
 *
 */
public class GSMCFACellGroupSummaryAggTest extends BaseDataIntegrityTest<GSMCFAGroupSummaryResult> {
    ...
    private void insertData(final String imsi, final String categoryID, final String cellID, final int tac,
    ...
    private void insertAggregatedEventData() throws Exception {
        ...
        insertAggregatedRow(TEST_VALUE_HIER321_ID_1, TEST_VALUE_CATEGORY_ID, 2, dateTime);
        insertAggregatedRow(TEST_VALUE_HIER321_ID_2, TEST_VALUE_CATEGORY_ID, 3, dateTime);
        insertAggregatedRow(TEST_VALUE_HIER321_ID_3, TEST_VALUE_CATEGORY_ID, 2, dateTime);
    }

    private void insertAggregatedRow(final String cellID, final String categoryID, final int numberOfErrors,
            final String time) throws SQLException {
        final Map<String, Object> aggregatedDataRow = new HashMap<String, Object>();
        aggregatedDataRow.put(HIER321_ID, cellID);
        ...
        final Map<String, Object> aggregatedDataSucRow = new HashMap<String, Object>();
        aggregatedDataSucRow.put(HIER321_ID, cellID);
        aggregatedDataSucRow.put(NO_OF_SUCCESSES, numberOfErrors);
        aggregatedDataSucRow.put(CATEGORY_ID, categoryID);
        aggregatedDataSucRow.put(DATETIME_ID, time);
        insertRow(TEMP_EVENT_E_GSM_CFA_HIER321_EVENTID_ERR_15MIN, aggregatedDataRow);
        insertRow(TEMP_EVENT_E_GSM_CFA_HIER321_EVENTID_SUC_15MIN, aggregatedDataSucRow);
    }
