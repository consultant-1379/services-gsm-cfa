 ...
 *
 */
public class ImsiDetailedEventRawTest extends BaseDataIntegrityTest<SubscriberDetailedEventAnalysisResult> {

    private DataConnectionSubscriberDetailedService service;

    @Before
    public void setup() throws Exception {
        service = new DataConnectionSubscriberDetailedService();
    ...
    public void testFiveMinuteQuery() throws URISyntaxException, Exception {
        ...
        verifyResult(result, TEST_VALUE_GSM_CELL1_NAME, TEST_VALUE_GSM_CONTROLLER1_NAME, TEST_VALUE_TAC,
                TEST_VALUE_MANUFACTURER, TEST_VALUE_MARKETING_NAME, 4/*we expect 4 because we also want the entry with exclusive TAC counted*/);
    }
    ...
    private void verifyResult(final String json, final String expectedCellName, final String expectedBscName,
        ...
        validateAgainstGridDefinition(json, "GSM_PS_SUBSCRIBER_SUMMARY_EVENT_ANALYSIS_BY_IMSI");
    ...
    private void verifyLeftOuterJoinValues(final String json) throws Exception {
        final SubscriberDetailedEventAnalysisResult jsonResult = getTranslator().translateResult(json,
                SubscriberDetailedEventAnalysisResult.class).get(0);
