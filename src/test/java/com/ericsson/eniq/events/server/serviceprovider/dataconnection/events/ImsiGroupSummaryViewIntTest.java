...
public class ImsiGroupSummaryViewIntTest extends ServiceBaseTest {

    @Resource(name = "imsiGroupFailureSummaryService")
    private SubscriberGroupSummaryService imsiGroupFailureSummaryService;
    ...
    public void testSubscriberDetailedEventData(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, imsiGroupFailureSummaryService);
    }
}
